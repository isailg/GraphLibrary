""" Programa principal
Ejecuta cada uno de los modelos de generación de grafos para 100 y 500 nodos, visualiza el grafo mediante el método Fruchterman-Reingold y el método Barnes-Hut escrito con pygame y guarda automáticamente el video con OpenCV.
